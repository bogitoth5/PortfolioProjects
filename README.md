...
**Data Cleaning with SQL** can be found [here](MavenFlixAnalysis/mavenflix_data_cleaning_sql)<br/>
**EDA in SQL** can be found [here](MavenFlixAnalysis/mavenflix_analysis_sql)
